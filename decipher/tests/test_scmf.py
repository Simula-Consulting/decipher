...
from decipher.matfact.model import SCMF
from decipher.matfact.model.config import ModelConfig
from decipher.matfact.model.factorization.factorizers.scmf import (
    _custom_roll,
...
def test_custom_roll(data):
    ...
    array = data.draw(arrays(np.float64, array_shapes(min_dims=2, max_dims=2)))
